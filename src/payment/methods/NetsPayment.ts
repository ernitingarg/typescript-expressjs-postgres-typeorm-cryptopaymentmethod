...
/**
 * Implementation of the IPayment interface for making Nets payments.
 */
export class NetsPayment implements IPayment {
  ...
  async makePaymentRequest(
    ...
    // Set the payment option to Nets (or any other initialization specific to nets payment)
